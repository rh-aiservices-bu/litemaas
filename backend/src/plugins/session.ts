...
const sessionPlugin: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.register(
    async function sessionRoutes(fastify) {
      ...
      fastify.delete('/sessions', {
        ...
        handler: async (request, _reply) => {
          const user = (request as AuthenticatedRequest).user;
          const currentSession = await sessionService.getSessionFromRequest(
  ...
  fastify.decorate('trackSession', async (request: AuthenticatedRequest, _reply: FastifyReply) => {
...
declare module 'fastify' {
  interface FastifyInstance {
    ...
    trackSession: (request: AuthenticatedRequest, reply: FastifyReply) => Promise<void>;
    createUserSession: (
      user: {
        id: string;
        username: string;
