...
const testTranslations = {
  ...
  'role.adminReadonly': 'Administrator (Read Only)',
  ...
  'pages.home.dashboard.completionTokens': 'Completion Tokens',
  'pages.home.dashboard.completionTokensAriaLabel': 'Completion tokens used in last 7 days: {{count}}',
  'pages.home.dashboard.copyEndpoint': 'Copy endpoint URL',
  'pages.home.dashboard.endpointCopied': 'Copied',
  'pages.home.dashboard.endpointCopiedDescription': 'API endpoint URL copied to clipboard',
  'pages.home.dashboard.endpointDescription': 'Use this URL to make API requests',
  'pages.home.dashboard.endpointTitle': 'API Endpoint',
  'pages.home.dashboard.noBudgetConfigured': 'No budget limit is currently configured for your account.',
  'pages.home.dashboard.promptTokens': 'Prompt Tokens',
  'pages.home.dashboard.promptTokensAriaLabel': 'Prompt tokens used in last 7 days: {{count}}',
  'pages.home.dashboard.tokenSubtitle': 'Last 7 days',
  'pages.home.dashboard.totalTokens': 'Total Tokens',
  'pages.home.dashboard.totalTokensAriaLabel': 'Total tokens used in last 7 days: {{count}}',
  ...
  'pages.tools.syncSuccess': 'Models synced successfully',
  'pages.tools.syncSuccessDetails': '{{total}} total models ({{new}} new, {{updated}} updated)',
  'pages.tools.syncError': 'Failed to sync models',
  'pages.tools.syncErrorGeneric': 'An error occurred while syncing models',
  'pages.tools.adminRequired': 'Admin access required',
  'pages.tools.lastSync': 'Last Sync',
  'pages.tools.syncTime': 'Sync Time',
  'pages.tools.totalModels': 'Total Models',
  ...
  'pages.tools.leaveEmptyToKeep': 'Leave empty to keep current value',
  'pages.tools.maxBudgetHelper': 'Maximum budget per user',
  'pages.tools.tpmLimitHelper': 'Tokens per minute limit',
  'pages.tools.rpmLimitHelper': 'Requests per minute limit',
  'pages.tools.applyToAllUsers': 'Apply to All Users',
  'pages.tools.processing': 'Processing...',
  'pages.tools.noValuesProvided': 'No values provided',
  'pages.tools.noValuesProvidedDescription': 'Please provide at least one value',
  'pages.tools.confirmBulkUpdate': 'Confirm Bulk Update',
  'pages.tools.confirmBulkUpdateMessage': 'Apply these limits to all users?',
  'pages.tools.changesToApply': 'Changes to Apply',
  'pages.tools.confirmApply': 'Confirm',
  'pages.tools.lastLimitsUpdate': 'Last Limits Update',
  'pages.tools.updateTime': 'Update Time',
  'pages.tools.totalUsersUpdated': 'Total Users',
  'pages.tools.successfulUpdates': 'Successful',
  'pages.tools.failedUpdates': 'Failed',
  'pages.tools.updateErrors': 'Errors',
  'pages.tools.bulkUpdateSuccess': '{{count}} users updated successfully',
  ...
  'pages.tools.applyChanges': 'Apply Changes',
  'pages.tools.bannerVisibilityNote': 'Single banner visibility',
  'pages.tools.bannerVisibilityNoteDescription': 'Only one banner can be visible at a time',
  'pages.tools.bannerDeleted': 'Banner deleted',
  'pages.tools.bannerDeletedDescription': 'The banner was deleted successfully',
  'pages.tools.bannerDeleteError': 'Failed to delete banner',
  'pages.tools.bannerDeleteErrorGeneric': 'Could not delete banner',
  'pages.tools.bannerCreated': 'Banner created',
  'pages.tools.bannerCreatedDescription': 'The banner was created successfully',
  'pages.tools.bannerSaved': 'Banner saved',
  'pages.tools.bannerSavedDescription': 'The banner was updated successfully',
  'pages.tools.bannerSaveError': 'Failed to save banner',
  'pages.tools.bannerSaveErrorGeneric': 'Could not save banner',

  // Users Page
  'users.pageDescription': 'Manage system users and their access',
  'users.permissions.accessDenied': 'Access Denied',
  'users.permissions.noPermission': 'You do not have permission to view users',
  'users.loading.title': 'Loading Users',
  'users.loading.description': 'Retrieving user information',
  'users.error.load': 'Failed to load users',
  'users.error.loadTitle': 'Error Loading Users',
  'users.error.loadDescription': 'An error occurred while loading users',
  'users.error.tryAgain': 'Try Again',
  'users.search.placeholder': 'Search users by name or email...',
  'users.search.ariaLabel': 'Search users',
  'users.filters.roleAriaLabel': 'Filter by role',
  'users.filters.statusAriaLabel': 'Filter by status',
  'users.filters.allRoles': 'All Roles',
  'users.filters.allStatus': 'All Status',
  'users.filters.clearAll': 'Clear All Filters',
  'users.filters.noMatches': 'No Matching Users',
  'users.filters.adjustFilters': 'Try adjusting your filters to see more results',
  'users.empty.title': 'No Users Found',
  'users.empty.description': 'There are no users in the system',
  'users.table.ariaLabel': 'Users table',
  'users.table.caption': '{{count}} user(s) in the system',
  ...
  'users.table.notProvided': 'Not provided',
  'users.table.moreRoles': '+{{count}} more',
  'users.pagination.of': 'of',
  'users.pagination.users': 'users',
  'users.actions.view': 'View',
  'users.actions.edit': 'Edit',
  'users.modal.defaultTitle': 'User Details',
  ...
  'users.form.lastLogin': 'Last Login',
  'users.form.createdAt': 'Created At',
  'users.never': 'Never',
  'users.alerts.inactive.title': 'Inactive User',
  'users.alerts.inactive.description': 'This user account is currently inactive',
  'users.alerts.admin.title': 'Administrator',
  'users.alerts.admin.description': 'This user has administrator privileges',

  // Chatbot Page
  'chatbot.title': 'Chatbot',
  'chatbot.pageDescription': 'Chat with AI models',
  'chatbot.configuration': 'Configuration',
  'chatbot.apiKey': 'API Key',
  'chatbot.model': 'Model',
  'chatbot.temperature': 'Temperature',
  'chatbot.maxTokens': 'Max Tokens',
  'chatbot.streaming': 'Enable Streaming',
  'chatbot.systemPrompt': 'System Prompt',
  'chatbot.noApiKeys': 'No API Keys Available',
  'chatbot.noModels': 'No Models Available',
  'chatbot.welcomePrompt': 'Welcome! How can I help you today?',
  ...
  'chatbot.error.loadApiKeys': 'Failed to load API keys',
  'chatbot.error.loadModels': 'Failed to load models',
